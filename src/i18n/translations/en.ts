...
export const en = {
  ...
  viewer: {
    ...
    intelligentAnalyzer: {
      ...
      generatedInsights: 'Based on the profile data, the main performance bottleneck appears to be in',
      checkMod: 'It is recommended to check configuration or updates related to {source}.',
      vanillaIssue: 'This seems to be a performance issue related to vanilla game logic.',
      unknownSource: 'Unknown source, possibly core or unrecognized library.',
    },
    ...enViewerDetails,
  },
  history: {
